...
from compressai.models import Cheng2020Anchor, Cheng2020Attention, FactorizedPrior, InvCompress, JointAutoregressiveHierarchicalPriors, MeanScaleHyperprior, ScaleHyperprior

from .pretrained import load_pretrained

__all__ = ["bmshj2018_factorized", "bmshj2018_hyperprior", "mbt2018", "mbt2018_mean", "cheng2020_anchor", "cheng2020_attn", "invcompress"]
...
cfgs = {
    "bmshj2018-factorized": {1: (128, 192), 2: (128, 192), 3: (128, 192), 4: (128, 192), 5: (128, 192), 6: (192, 320), 7: (192, 320), 8: (192, 320)},
    "bmshj2018-hyperprior": {1: (128, 192), 2: (128, 192), 3: (128, 192), 4: (128, 192), 5: (128, 192), 6: (192, 320), 7: (192, 320), 8: (192, 320)},
    "mbt2018-mean": {1: (128, 192), 2: (128, 192), 3: (128, 192), 4: (128, 192), 5: (192, 320), 6: (192, 320), 7: (192, 320), 8: (192, 320)},
    "mbt2018": {1: (192, 192), 2: (192, 192), 3: (192, 192), 4: (192, 192), 5: (192, 320), 6: (192, 320), 7: (192, 320), 8: (192, 320)},
    "cheng2020-anchor": {1: (128,), 2: (128,), 3: (128,), 4: (192,), 5: (192,), 6: (192,)},
    "cheng2020-attn": {1: (128,), 2: (128,), 3: (128,), 4: (192,), 5: (192,), 6: (192,), 7: (256,), 8: (384,)},
    "invcompress": {1: (128,), 2: (128,), 3: (128,), 4: (128,), 5: (192,), 6: (192,), 7: (192,), 8: (192,)},
}


def _load_model(architecture, metric, quality, pretrained=False, progress=True, ch=3, **kwargs):
    ...
    if pretrained:
        if architecture not in model_urls or metric not in model_urls[architecture] or quality not in model_urls[architecture][metric]:
    ...
    try:
        print("try channel is:", ch)
        if quality >= 4 and ch == 1:
            model = model_architectures[architecture](128, ch=ch, **kwargs)  # 仍然128
        else:
            model = model_architectures[architecture](*cfgs[architecture][quality], ch=ch, **kwargs)
    except:
        print("except channel is:", ch)
...
def bmshj2018_factorized(quality, metric="mse", pretrained=False, progress=True, **kwargs):
    ...
    return _load_model("bmshj2018-factorized", metric, quality, pretrained, progress, **kwargs)
...
def bmshj2018_hyperprior(quality, metric="mse", pretrained=False, progress=True, **kwargs):
    ...
    return _load_model("bmshj2018-hyperprior", metric, quality, pretrained, progress, **kwargs)
...
def cheng2020_attn(quality, metric="mse", pretrained=False, progress=True, **kwargs):
    ...
    return _load_model("cheng2020-attn", metric, quality, pretrained, progress, **kwargs)


def invcompress(quality, metric="mse", pretrained=False, progress=True, ch=3, **kwargs):
    ...
    return _load_model("invcompress", metric, quality, pretrained, progress, ch=ch, **kwargs)
